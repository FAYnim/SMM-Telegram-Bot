<?php
// Handle edit campaign detail callback
if($cb_data && strpos($cb_data, '/edit_campaign_detail_') === 0) {
    // get campaign id
    $campaign_id = str_replace('/edit_campaign_detail_', '', $cb_data);
    ...
    if (!empty($campaign)) {
        ...
        } elseif ($campaign_data['status'] == 'paused') {
            $keyboard_buttons[] = [
